...
export default function ToolCard({ title, description, Icon, link }) {
  return (
    <Link href={link}>
      <div className="group w-full h-[170px] border border-[var(--border-color)] rounded-lg p-5 hover:border-[var(--hover-border)] duration-500 ease-in-out cursor-pointer bg-white flex flex-col items-start justify-between">
